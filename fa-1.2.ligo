...
function test_storage (const s : contract_storage) : string is "Parameter(contract_storage) OK!"

function test_transfer_func (const accountFrom : address ; const destination : address ; const value : amt ; var s : contract_storage ) : string is 
 begin
   var ret : string := "OK!";
