...
let test_bigmap = (b : big_map(int, string)) : string => "Parameter(big_map) OK!"
let test_bytes = (b : bytes) : string => "Parameter(bytes) OK!"
let test_timestamp = (b : timestamp) : string => "Parameter(timestamp) OK!"
let test_storage = (s : storage) : string => "Parameter(storage) OK!"
let test_commit = (c: commit) : string => "Parameter(commit) OK!"
